...
function getWeather() {
  fetch(`${BASE_URL}q=${city.value}&units=metric&appid=${API_KEY}`).then(
    (response) => response.json().then((data) => (weatherInfo.value = data))
  );
}
            ...
            >
              <div class="info">
                ...
                <div v-else class="error">
                  <div class="error title">Oooooops! Something went wrong</div>
